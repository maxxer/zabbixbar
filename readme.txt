...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\zabbixbar on
     Windows, /home/user/dev/zabbixbar on Linux) in a file named
     zabbix@alberto.gonzlez.rodrguez and copy that file to
